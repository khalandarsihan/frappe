context("List Paging", () => {
	...
	it("test load more with count selection buttons", () => {
		...
		cy.get(
			'.list-paging-area .btn-group .btn-paging[data-value="100"]',
		).click();

		cy.get(".list-paging-area .list-count").should(
			"contain.text",
			"100 of",
		);
		cy.get(".list-paging-area .btn-more").click();
		...
		cy.get(
			'.page-head .standard-actions [data-original-title="Reload List"]',
		).click();
		cy.get(".list-paging-area .list-count").should(
			"contain.text",
			"300 of",
		...
		cy.get(
			'.list-paging-area .btn-group .btn-paging[data-value="500"]',
		).click();
